...
Pacific Ocean meridional mass (in Sv $\equiv$ 10$^9$ kg/s) and heat (in PW $\equiv$ 10$^{15}$ J\, s$^{-1}$) transports, in both Southern and Northern Hemispheres, for equilibrium state solution. Computations consider mass balance adjusted to zero across 24$^o$S and 24$^o$N, respectively. 
